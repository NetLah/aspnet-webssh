...
$mappingVersionArch = @{
    ...
    '^11\.0(\.\d+)?-preview[^-]*-resolute$'          = '11.0-preview-resolute', '11.0-resolute', '11.0-preview', '11.0', 'resolute'
    '^11\.0(\.\d+)?-preview[^-]*-resolute-chiseled$' = '11.0-preview-resolute-chiseled', '11.0-resolute-chiseled', '11.0-preview', 'resolute-chiseled'
    
    '^11\.0(\.\d+)?-rc[^-]*-alpine(.*)$'             = '11.0-rc-alpine', '11.0-alpine', '11.0'
    '^11\.0(\.\d+)?-rc[^-]*-trixie-slim$'            = '11.0-rc-trixie-slim', '11.0-trixie-slim', '11.0-rc', '11.0', 'trixie-slim'
    '^11\.0(\.\d+)?-rc[^-]*-resolute$'               = '11.0-rc-resolute', '11.0-resolute', '11.0-rc', '11.0', 'resolute'
    '^11\.0(\.\d+)?-rc[^-]*-resolute-chiseled$'      = '11.0-rc-resolute-chiseled', '11.0-resolute-chiseled', 'resolute-chiseled'
    
    '^11\.0(\.\d+)?-alpine(.*)$'                     = '11.0-alpine', '11.0'
    '^11\.0(\.\d+)?-trixie-slim$'                    = '11.0-trixie-slim', '11.0', 'trixie-slim'
    '^11\.0(\.\d+)?-resolute$'                       = '11.0-resolute', '11.0', 'resolute'
    '^11\.0(\.\d+)?-resolute-chiseled$'              = '11.0-resolute-chiseled', 'resolute-chiseled'
    '^11\.0(\.\d+)?-azurelinux3.0$'                  = '11.0-azurelinux3.0', '11.0', 'resolute'
}
...
$mappingArch = @{
    ...
    '9.0-preview-noble'              = 'debian'  #ubuntu 24.04 LTS
    '9.0-preview-noble-chiseled'     = 'debian'  #ubuntu 24.04 LTS
    '9.0-rc-alpine'                  = 'alpine'
    '9.0-rc-bookworm-slim'           = 'debian'
    '9.0-rc-noble'                   = 'debian'  #ubuntu 24.04 LTS
    '9.0-rc-noble-chiseled'          = 'debian'  #ubuntu 24.04 LTS
    '9.0-alpine'                     = 'alpine'
    ...
    '11.0-preview-resolute-chiseled' = 'debian'  # NOTUSE #ubuntu 26.04 LTS
    '11.0-rc-alpine'                 = 'alpine'
    '11.0-rc-trixie-slim'            = 'debian'  # NOTUSE
    '11.0-rc-resolute'               = 'debian'  #ubuntu 26.04 LTS
    '11.0-rc-resolute-chiseled'      = 'debian'  # NOTUSE  #ubuntu 26.04 LTS
    '11.0-alpine'                    = 'alpine'
    '11.0-resolute'                  = 'debian'  #ubuntu 26.04 LTS
    '11.0-resolute-chiseled'         = 'debian'  #NOTUSE ubuntu 26.04 LTS
}
